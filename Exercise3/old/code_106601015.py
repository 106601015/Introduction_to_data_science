...
class DecisionTreeClassifier:
    ...
    def _feature_split(self, X, y,n_classes):
        ...
        if self.criterion == "gini":
            best_criterion = self._gini(y,n_classes) #𝐺𝑖𝑛𝑖(𝐷)
        else:
            best_criterion = self._entropy(y,n_classes) #Info(𝐷)
        ...
        if self.criterion == "gini":
            ...
            for feature_index in range(X.shape[1]):
                ...
                for thr in range(1, X_order.shape[0]):
                    # culculate 𝐺𝑖𝑛𝑖(𝐷𝑖) and 𝐺𝑖𝑛𝑖_𝐴(𝐷)
            ...
            for feature_index in range(X.shape[1]):
                ...
                # consider all the midpoints between adjacent training samples as possible thresholds.
                for thr in range(1, X_order.shape[0]):
                    # culculate Info(𝐷𝑖) and Info_𝐴(𝐷)
